...
function testForDeclaration(node) {
    ...
    var isDefinedInFunctionDeclaration;
    ...
    if (node.parent) {
        ...
        isDefinedInFunctionDeclaration = node.parent.type == "FunctionDeclaration" && node.type == "Identifier";
    }

    return isVariabledDeclarator || isDefinedInFunctionExpression || isDefinedInFunctionDeclaration;
}
...
function testForIdentifier(node) {
    ...
    return node.type === 'Identifier' &&
           ...
           // ignore the parameters of function declarations
           ...
           (node.parent.type !== "Property" || (node.parent.type === "Property" && node.start !== node.parent.start)) &&
